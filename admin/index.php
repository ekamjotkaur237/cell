    ...
    <div class="col-md-4">
        <div class="card text-white bg-primary mb-3">
            ...
            <div class="card-body">
                ...
                <a href="#" class="btn btn-light">Go to Clubs</a>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card  bg-warning mb-3">
            ...
            <div class="card-body">
                ...
                <a href="#" class="btn btn-light">Go to Candidates</a>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card text-white bg-success mb-3">
            ...
            <div class="card-body">
                ...
                <a href="#" class="btn btn-light">Go to Voters</a>
            </div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card text-white bg-info mb-3">
            ...
            <div class="card-body">
                ...
                <p class="card-text">See the real-time election results and statistics.</p>
                <a href="#" class="btn btn-light">Go to Results</a>
            </div>
        </div>
    </div>
</div>
